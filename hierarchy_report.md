...
Hеализована и протестирована модель на основе графовых сверточных сетей, вдохновленная статьей "Text Level GCN and GloVe".
...
**Таблица 1. Результаты первоначального сравнения (метрика - Accuracy)**
...
**Таблица 3. Результаты сравнения с использованием ранжирующих метрик (Accuracy@k, MRR)**
...
Нельзя сказать, какой из методов лучше. Однако, обучение HMCN производилось на 100 эпох. Это заняло в 100 раз больше времени, чем у AutoIntent. Исходя из затрат на обучение победителем признан AutoIntent.
